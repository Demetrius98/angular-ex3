...
/* harmony import */ var _shared_token_interceptor_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./shared/token-interceptor.service */ "./src/app/shared/token-interceptor.service.ts");
/* harmony import */ var _build_chat_build_chat_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./build-chat/build-chat.component */ "./src/app/build-chat/build-chat.component.ts");
/* harmony import */ var _shared_icon_label_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./shared/icon-label.pipe */ "./src/app/shared/icon-label.pipe.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _build_chat_build_chat_component__WEBPACK_IMPORTED_MODULE_13__["BuildChatComponent"],
            _shared_icon_label_pipe__WEBPACK_IMPORTED_MODULE_14__["IconLabelPipe"]
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BuildChatComponent", function() { return BuildChatComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _shared_messenger_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/messenger.service */ "./src/app/shared/messenger.service.ts");
/* harmony import */ var _entity_Chat__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../entity/Chat */ "./src/app/entity/Chat.ts");




let BuildChatComponent = class BuildChatComponent {
    constructor(_messengerService) {
    ...
    createChat() {
        let chat = new _entity_Chat__WEBPACK_IMPORTED_MODULE_3__["Chat"]();
...
BuildChatComponent.ctorParameters = () => [
    { type: _shared_messenger_service__WEBPACK_IMPORTED_MODULE_2__["MessengerService"] }
];
BuildChatComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-build-chat',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./build-chat.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/build-chat/build-chat.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./build-chat.component.css */ "./src/app/build-chat/build-chat.component.css")).default]
    })
], BuildChatComponent);
...
/* harmony import */ var _shared_messenger_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/messenger.service */ "./src/app/shared/messenger.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(_auth, _router, _messengerService) {
        this._auth = _auth;
...
let MainPageComponent = class MainPageComponent {
    ...
    constructor(_authService, _router, _messengerService) {
...
/* harmony import */ var _messenger_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./messenger.service */ "./src/app/shared/messenger.service.ts");




let AuthService = class AuthService {
    constructor(http, _messengerService) {
        this.http = http;
        this._messengerService = _messengerService;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconLabelPipe", function() { return IconLabelPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let IconLabelPipe = class IconLabelPipe {
    transform(chat) {
        if (chat.group) {
            return "G";
        }
...
IconLabelPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _entity_Chat__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../entity/Chat */ "./src/app/entity/Chat.ts");
/* harmony import */ var _entity_Message__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../entity/Message */ "./src/app/entity/Message.ts");
...
let MessengerService = class MessengerService {
    ...
    getAuthenticatedUser() {
        return this.http.get(this._userUrl).subscribe((res) => {
            this.user.next(res);
            console.log(res);
        }, err => {
            console.log(err);
    ...
    getChats() {
        return this.http.get(`${this._userUrl}/chats`).subscribe((res) => {
            this.chats.next(res);
            console.log(res);
    ...
    addMessage(text) {
        ...
        let message = new _entity_Message__WEBPACK_IMPORTED_MODULE_6__["Message"]();
...
module.exports = __webpack_require__(/*! /home/dmitry/programming/webProject/MessengerInterface/src/main.ts */"./src/main.ts");
